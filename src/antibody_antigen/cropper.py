...
class AntiGenCropper:
    ...
    def crop(
        ...
        for chain_name, epi_res_list in epitope_by_chain.items():
            ...
            for core_idx in epi_indices:
                ...
                while len(current_window) < self.neighborhood_size:
                    ...
                    if (
                        len(current_window) < self.neighborhood_size
                        and max_idx < len(all_chain_res) - 1
                    ):
                        max_idx += 1
        ...
        coords = []
        atom_types = []
        atom_names = []  # ADDED: To store atom names like 'CA', 'CB', etc.
        ...
        for local_res_idx, (c_id, res) in enumerate(cropped_residues_list):
            ...
            for atom in res:
                ...
                atom_names.append(atom.name)  # ADDED: Store atom name
        ...
        return {
            ...
            "atom_names": np.array(atom_names, dtype=str),  # ADDED: Atom names
